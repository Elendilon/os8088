...
;
; WHY IT EXISTS. On a 128KB machine kern_small leaves ~32.5KB of heap
...
NP_XN     equ 32                ; THE ONE PLACE APP_SMALL TRADES SPEED FOR
                                ...
                                ; cost, and this machine has ~32.5KB of heap
%else
...
; machine kern_small leaves ~32.5KB of heap in total.
; -----------------------------------------------------------------------------
np_uclear:
np_uclose:
np_ubegin:
