...
| **[docs/FIELD-NOTES.md](docs/FIELD-NOTES.md)** | bugs reported off real hardware, one numbered entry each — eight still open (3, 10, 14, 19, 24.2, 28, 32, 41) with what has been ruled out and what to try next; the closed ones are a paragraph naming the fix and its §, kept because code and SPEC.md cite the numbers |
