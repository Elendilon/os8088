...
Removing it was 84 bytes of `.text`+`.bss` and 190 of `.cold` — enough to
drop the cold rung 40 → 39 × 512 — and `KERN_BUDGET`'s **eleventh move,
86,528 → 86,016**, the second downward one. Two things it did NOT take with
