...
that is the feature, and every decision falls out of it. Slots 0x0310
(`clip_put`, ES:SI + CX, CX = 0 empties it), 0x0318 (`clip_get`, ES:DI + CX,
answering the whole length in AX and the bytes copied in CX) and 0x0320
(`clip_size`, what a paste asks BEFORE it makes room).
