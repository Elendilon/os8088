...
### Set 137 — the 176 ms was never measured, and the band that replaced it was 2.4× slower than the slot (SPEC.md §93.5.5)
...
### Set 138 — where a DOT DELIRIUM frame goes, and the 677 ms nobody had priced (SPEC.md §93.5.3.1)
