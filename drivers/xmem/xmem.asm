...
; through cpu_info's AH (slot 0x015C) exactly as it always did. On a machine
...
; -----------------------------------------------------------------------------
; xm_caps - what is left up there? (XMV_CAPS, behind slot 0x0162)
;
...
; -----------------------------------------------------------------------------
; xm_alloc - first-fit a run of extended memory (XMV_ALLOC, slot 0x0168)
;
...
; -----------------------------------------------------------------------------
; xm_free - give a block back (XMV_FREE, slot 0x016E)
;
...
;           (XMV_COPY, behind slot 0x0174, SPEC.md 41.5)
;
