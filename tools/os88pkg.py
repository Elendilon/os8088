...
def main() -> int:
    ...
    ap.add_argument("--compress", metavar="FMT", nargs="?", const="lz4",
                    ...
                    help="compress the image, unpacked by the loader "
                         "(docs/plans/completed/O88-COMPRESSION-PLAN.md 7). The header, icon "
...
# --- compression (docs/plans/completed/O88-COMPRESSION-PLAN.md 7, 12.5) ----------------------
...
def compress_image(out: bytearray, image: int, bss: int, flags: int,
    ...
    if flags & 4:
        return refuse(
            ...
            "circular. docs/plans/completed/O88-COMPRESSION-PLAN.md wave 4 (OP_COMP) is where "
