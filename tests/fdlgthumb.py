...
"""SPEC.md 13.10.5: the Standard File dialog's thumb is dragged too.
    ...
    make SBDRAG=1 && python3 tests/fdlgthumb.py [machine]

A KNOB build's gate, like tests/fmthumb.py, and not in a tier for the same
reason - tests/unit/t_registry.py exempts both and says why.
