...
docs/plans/completed/O88-COMPRESSION-PLAN.md wave 6; SPEC.md 20.15 is the module and 22.22 the
...
def build_disk(path):
    ...
    # the run's own tree and not in build/ (docs/plans/completed/SOAK-PARALLEL.md 14.2) -
...
def compress(m, mo, wx, wy, name, fails, quiet=30):
    ...
    given a third less CPU (docs/plans/completed/SOAK-PARALLEL.md 1).
    """
