...
PERFORMANCE.md Set 134.3 priced the walk conversion (SPEC.md 5.12.5) at −33.5%
...
and not enough to trust a size; Set 134.2 had to measure blocks-per-call
...
def main():
    ...
    if dsc is not None:
        ...
        # PERFORMANCE.md Set 134.3 quotes a median and comparing one statistic
