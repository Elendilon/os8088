...
"""SPEC.md 13.10.7: the thumb gesture inside a PACKAGE.
    ...
    make SBDRAG=1 && python3 tests/pkgthumb.py notepad|browser|texpad

A knob gate (tests/unit/t_registry.py exempts it and says why), and one file
for three apps rather than three files, because the subject is not Note Pad -
