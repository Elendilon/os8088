...
**This is not `docs/plans/completed/HANDOFF.md`** — that file holds a live handover for the
...
changing slot 0x028F's contract and adding invariant surface to the file path.
