...
`evq_pending` (`events.inc:161`, API 0x0284) already reads that word, and reads
...
> box does.
>
> docs/plans/completed/UIHELPERS-PLAN.md §15 is the landed work and the survey of what still
> has no down state.
