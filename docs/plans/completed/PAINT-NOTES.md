...
sets **`WF_OWNBG`** (`OSAPI_WM_OWNBG`, slot 0x02D1) to stop it. The flag says
...
docs/plans/completed/HANDOFF-REDRAW.md item B2** against two-point fits of the measured per-run
