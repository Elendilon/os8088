...
docs/plans/completed/PAINT-NOTES.md. A window that resizes itself inside its own `W_PAINT` was
...
docs/plans/LAST-DROP-PERF.md 3 is the costing, kept as the record of a deliberate
...
RECTANGLES and so needs no region arithmetic anywhere: `wm_band` (slot 0x02DF),
