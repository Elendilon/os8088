...
The counterpart to `docs/plans/completed/PAINT-NOTES.md`. Note Pad's *implemented* behaviour is
...
docs/plans/completed/NOTEPAD-NOTES.md §5.2.1 was that noise, and it survived because nobody
...
menu bar, `OSAPI_TOAST` at slot 0x02B6. What went with it from this module:
