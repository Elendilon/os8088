...
| `0x0550` | `OSAPI_MEM_AVAIL_MAX` | out AX/BX as OSAPI_MEM_AVAIL, planned as if YOUR OWN REGION could move... |
| `0x0558` | `OSAPI_MEM_COMPACT_WAKE` | BX = a window of YOURS, AL = the shed rank the pass must respect (MEM_LVL_TOP to let it drop any cache)... |
...
*Measurements, each true of the tree it was taken on - `docs/reports/` (11):* `BUSY-CURSOR-COST-2026-09-10.md`, `CYCLONE-STACK-2026-09-10.md`, `DOTDEL-FRAME-PROFILE-2026-09-09.md`, `GLYPH-AND-LINE-COST-2026-09-10.md`, `KERNEL-BYTES-SINCE-SQUASH-2026-09-07.md`, `MODULE-RESIDENT-DATA-2026-09-12.md`, `PR-CYCLE-ACCOUNTING-2026-09-11.md`, `SBRATE-COMMIT-COST-2026-09-11.md`, `SKIES-FRAME-DELTA-2026-09-10.md`, `STKDIAG-PC5150-2026-09-10.md`, `TIER-TIMINGS-2026-09-07.md`
